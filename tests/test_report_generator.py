...
from reports.report_generator import generate_report # Replace with your actual function and module
...
def test_invalid_data_format():
    mock_data = "Invalid data"  # Simulating invalid format (e.g., string instead of dictionary)
...
def test_json_report_format():
    ...
    result = generate_report(mock_data, format="json")  # Assuming the 'format' argument is accepted
...
def test_csv_report_format():
    ...
    result = generate_report(mock_data, format="csv")  # Assuming the 'format' argument is accepted
...
@patch('your_module.external_data_source', return_value={'task_id': '12345', 'task_name': 'External Task'})
