...
def test_scan_packages_failure(mock_subprocess, mock_config_data):
    ...
    mock_subprocess.side_effect = subprocess.CalledProcessError(1, 'osh-cli', 'Error during scan')
...
def test_main(mock_create_manifest, mock_lookup_in_manifest, mock_get_manifest, mock_get_package_list, mock_config_data):
